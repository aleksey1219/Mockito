...
class EmployeeServiceImplTest {
    ...
    @Test
    void findAll() {
        employeeService.addEmploee("tests", "tests" + "s", "asf", 1, 231);
        employeeService.addEmploee("testf", "tests" + "s", "asf", 2, 232);
        employeeService.addEmploee("testb", "tests" + "s", "asf", 3, 233);
        ...
        Assertions.assertThat(all).containsExactlyInAnyOrder(
                new Employee("tests", "tests" + "s", "asf", 1, 231),
                new Employee("testf", "tests" + "s", "asf", 2, 232),
                new Employee("testb", "tests" + "s", "asf", 3, 233));
    }
}